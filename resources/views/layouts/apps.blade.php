...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Join us</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="{{route('auth.login')}}">Client</a></li>
              <li><a href="{{route('auth.agent-login')}}">Agent</a></li>
            </ul>
          </li>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container mt-4">
      <div class="copyright">
        &copy; Copyright <strong><span>CodeEagles</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
