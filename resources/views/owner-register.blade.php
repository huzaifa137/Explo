        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="signup-form">
                    <form action="{{route('create.owner')}}" class="mt-5 border p-4 bg-light shadow" method="POST">
                        @csrf
                        <h4 class="mb-5 text-secondary">Create a Owner Account</h4>
                    ...
                    <p class="text-center mt-3 text-secondary">If you have account, Please <a href="{{route('owner.login')}}">Login Now</a></p>
