            ...
            <div class="row" id="proBanner">
              <div class="col-12">
                <span class="d-flex align-items-center purchase-popup">
                  ...
                  <a href="#" class="btn ml-auto download-button">Explo Client Dashboard</a>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">My Tasks</h5>
                            <h2 class="mb-4 text-dark font-weight-bold">{{$info}}</h2>
                            <div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-lightbulb icon-md absolute-center text-dark"></i></div>
                            <p class="mt-4 mb-0">All Tasks</p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark">{{$info}}.0</h3>
                          </div>
                        </div>
                      </div>
