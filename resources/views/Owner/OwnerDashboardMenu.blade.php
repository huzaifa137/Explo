              ...
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                  <div class="nav-profile-img">
                    <img src="/assets2/images/faces/face28.png" alt="image">
                    {{-- <img src="{{ url('public/agent_profile_pic/'.$LoggedUser1->profile_photo) }}" alt="image"> --}}
                  </div>
                  <div class="nav-profile-text">
                    <p class="mb-1 text-black">OWNER-{{$Loggedowner['name']}}</p>
                  </div>
                </a>
                <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                  <div class="p-3 text-center bg-primary">
                    <img src="/assets2/images/faces/face28.png" alt="image">
                    {{-- <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ url('public/agent_profile_pic/'.$LoggedOwner->profile_photo) }}" alt=""> --}}
                  </div>
                  <div class="p-2">
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="#">Assign a Task</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#ui-info" aria-expanded="false" aria-controls="ui-basic">
                ...
                <div class="collapse" id="ui-info">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('owner.client-info')}}">Clients</a></li>
